    ...
    return (
      <div className="container mx-auto py-8 px-4 max-w-md text-center">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <button 
            onClick={loadUsers}
            className="w-full text-white font-semibold py-3 px-6 rounded-lg transition-all"
            style={{ backgroundColor: 'rgb(79, 70, 229)' }}
            onMouseEnter={(e) => (e.target as HTMLButtonElement).style.backgroundColor = 'rgb(67, 56, 202)'}
            onMouseLeave={(e) => (e.target as HTMLButtonElement).style.backgroundColor = 'rgb(79, 70, 229)'}
          >
            Try Again
          </button>
        </div>
