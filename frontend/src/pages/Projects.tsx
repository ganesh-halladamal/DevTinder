    ...
    return (
      <div className="container mx-auto py-8 px-4 max-w-4xl">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6 text-center">
          <h2 className="text-xl font-semibold text-red-700 dark:text-red-400 mb-2">Error Loading Projects</h2>
        ...
        {projects.length > 0 ? (
          <div className="space-y-6">
            {projects.map((project) => (
              <div key={project._id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:shadow-md transition-shadow dark:bg-gray-800/50">
          ...
          <div className="text-center py-16 bg-gray-50 dark:bg-gray-900 rounded-lg">
            <Code className="h-16 w-16 mx-auto text-gray-400 dark:text-gray-500 mb-4" />
            <h2 className="text-2xl font-medium text-gray-700 dark:text-gray-300 mb-2">No Projects Yet</h2>
            <p className="text-gray-500 dark:text-gray-400 mb-6">Showcase your work by adding projects to your profile</p>
            <Link
              to="/profile/edit"
